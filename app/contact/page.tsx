 ...
 <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center w-full ">
            ...
            <p className="text-xl text-neutral-300 leading-relaxed max-w-2xl mx-auto w-full">
              Get in touch with our experts for personalized welding solutions and competitive quotes.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-2  gap-8 mb-16 max-w-7xl w-full mx-auto">
              ...
              <Card className="text-center shadow-none text-black border border-neutral-200 bg-gradient-to-br from-neutral-50 to-neutral-100">
                <CardContent className="p-8 max-w-xs w-full m-auto">
                  ...
                  <p className="text-lg font-semibold  break-all">{contactData.phone.number}</p>
                </CardContent>
              </Card>
   ...
   <Card className="text-center shadow-none text-black border border-neutral-200 bg-gradient-to-br from-neutral-50 to-neutral-100">
                <CardContent className="p-8 max-w-xs w-full m-auto">
                  ...
                  <p className="text-lg font-semibold break-all">{contactData.email.address}</p>
                </CardContent>
              </Card>
   ...
   <Card className="text-center shadow-none text-black border border-neutral-200 bg-gradient-to-br from-neutral-50 to-neutral-100">
            ...
            <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
              <Card className="border shadow-none  h-full">
                <CardHeader>
                  <CardTitle className="text-2xl text-neutral-900">Send us an Enquiry</CardTitle>
                ...
                <CardContent className="h-full">
                  <form onSubmit={handleSubmit} className="h-full flex flex-col gap-6 justify-between">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center space-x-2">
                        ...
                        {formData.file && <span className="text-sm text-neutral-600">{formData.file.name}</span>}
                      </div>
              ...
              <div className="space-y-8">
                <Card className="border bg-white shadow-none">
                  <CardHeader>
                    <CardTitle className="text-xl text-neutral-900">Visit Our Office</CardTitle>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="space-y-2 text-sm text-neutral-600">
                      ...
                      <p>
                        <strong>Public Transport:</strong> Metro Station 2 blocks away
                      </p>
                    </div>
                  </CardContent>
                </Card>
